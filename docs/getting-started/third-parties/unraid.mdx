...
<Tabs groupId="unraid-permissions" queryString>
  ...
  |---|---|
  | **Name** | `seerr` |
  | **Repository** | `ghcr.io/hapsiellx/paintedclouds-hub:0.3.0` |
  | **Icon URL** | `https://raw.githubusercontent.com/HapsiellX/paintedclouds-hub/v0.3.0/public/android-chrome-512x512.png` |

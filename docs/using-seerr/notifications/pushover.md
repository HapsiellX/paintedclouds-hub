...
[Register an application](https://pushover.net/apps/build) and enter the API token in this field. (You can use one of the [official icons in our GitHub repository](https://github.com/HapsiellX/paintedclouds-hub/tree/main/public) when configuring the application.)
